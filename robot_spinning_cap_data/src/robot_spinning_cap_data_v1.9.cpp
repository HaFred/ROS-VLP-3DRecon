 ...
 * @file 
 *
 * @brief 1.9 is a minimum workable template for image cap and data pose saving, did not include bag and complex motion. Pose saved is correct and updated for every snap?
 * 
 *      It seems like the pose cannot be updated, it stuck at the init pose
 *
 * @date Nov 24, 2021
 *
 * @author HaFred
